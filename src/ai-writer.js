...
**笔记主题中没有明确课文名时**（家长会、班主任经验、育儿话题、教师成长等）：
...
**【最重要】只根据笔记主题中明确出现的信息撰写，不得自行补充用户未提及的事实、人物、场景、数字、课程名称或具体细节。笔记主题里没有写的内容，一律不出现在正文中。**

内容类型不同，写法不同：

**A. 课文/教案/课件类**（有明确课文名或教学环节）：
围绕笔记主题的核心关键词展开，简单描述教学内容涉及的信息点，说清楚就好。
不需要表达使用感受，不需要分析价值，也不需要"分享视角"的铺垫。

**B. 家长会/班主任经验/育儿类**（无课文名，以教师经历或沟通场景为主）：
用第一人称场景还原，按"开场交代场合 → 对比做法 → 具体内容 → 家长反应"结构展开。
核心句式：「那天家长会，我没讲大道理。我做的是……讲完之后，……」
对比结构：没做XX（常见无效做法）→ 只做了YY（具体有效方法，要写出细节）→ 结果ZZ（家长/学生的真实画面，不用"效果好"这类空话）。
禁止抽象收尾，如「效果很好」「家长们都很满意」，要有具体画面感（「有人当场记笔记」「有人问老师还有下一场吗」）。
**注意：画面感描写只能用通用场景（有人记笔记、有人追问），不得编造用户未提及的具体数字、时间、人数、班级情况。**
...
正确示例——课文类：
{"title":"四下《母鸡》这样讲，思路好清晰啊","description":"统编版四年级下册《母鸡》第一课时。\n导入环节从学生生活中的母鸡印象切入，对比课文中「我」对母鸡态度的前后变化。\n精读部分重点关注三个场景：母鸡的炫耀、欺软怕硬和夜间警觉。\n最后引导学生体会作者情感转变背后的原因，感受母爱主题。","tags":["#母鸡","#四年级语文","#第一课时","#小学语文","#教学设计"]}

正确示例——家长会类：
{"title":"期末家长会这样开，家长全都听进去了","description":"那天家长会，我没讲大道理，也没发成绩单之后的沉默。\n我只做了一件事：把「孩子回家写作业最容易卡在哪一步」这个问题，认认真真讲了20分钟。\n分三个阶段：坐下来难、开头难、坚持到最后难。每个阶段给了一个具体的应对方法。\n讲完之后家长没有散场，有人问「老师还有下一场吗」，有人当场记笔记。","tags":["#家长会","#期末家长会","#班主任","#小学班主任","#家校共育","#班主任工作"]}`;
