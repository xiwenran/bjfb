...
围绕笔记主题描述具体内容，说清楚讨论了哪些重点。
不用第一人称叙事句式（如「我没讲大道理」「我做的是」），不补充用户未提及的数字、时间、阶段结构。
...
正确示例——家长会类：
{"title":"期末家长会这样开，家长全都听进去了","description":"期末家长会内容整理。\n围绕孩子期末阶段学习状态和家校配合重点展开。\n聊了孩子在家复习的常见问题以及假期衔接的实用建议。","tags":["#家长会","#期末家长会","#班主任","#小学班主任","#家校共育","#班主任工作"]}`;
